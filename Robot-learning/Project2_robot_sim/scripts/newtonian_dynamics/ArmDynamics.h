...
class ArmDynamics: public ChainDynamics{

public:
	ArmDynamics(uint num_links, double link_mass, double link_length, double torques_max, double coeff_viscous_joint,
	...
	uint get_state_dim() {return  2*num_links_;}
	uint get_action_dim() {return  num_links_;}
};
